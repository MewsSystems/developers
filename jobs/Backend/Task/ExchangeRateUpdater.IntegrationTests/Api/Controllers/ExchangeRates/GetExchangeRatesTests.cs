...
public class GetExchangeRatesTests : IClassFixture<WebApplicationFactory<Program>>
{
    ...
    public async Task GetExchangeRates_When_requested_once_Then_response_is_returned_from_http_as_expected()
    {
        ...
        restClientMock //Mocking an external dependency in an integration test is not ideal. It would be better to have a Testcontainer with the service contained in it, so we can really test the connection to an external dependency.
        ...
        var httpClient = _webApplicationFactory
            ...
            {
                testServices.AddScoped(_ => restClientMock.Object);
