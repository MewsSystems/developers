...
namespace ExchangeRateUpdater.ApiTests.NewFolder;

[Collection("ExchangeRateUpdaterTests")]
public class GivenSingleCurrencyWhenGetExchangeRatesIsCalled(ExchangeRateUpdaterApplicationFactory factory) : IAsyncLifetime
{
    ...
    [InlineData("EUR")]
    [InlineData("eur")]
    public async void Then200OkResponseReturnedWithExchangeRateInCorrectFormat(string currencyCode)
    {
        var getExchangeRatesQuery = new GetExchangeRatesByCurrencyQuery(CurrencyCodes: [currencyCode], ForDate: _queryDate);
