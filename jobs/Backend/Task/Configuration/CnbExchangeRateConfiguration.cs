...
public class CnbExchangeRateConfiguration
{
    ...
    /// </summary>
    public string ApiUrl { get; init; } = "https://www.cnb.cz/en/financial-markets/foreign-exchange-market/central-bank-exchange-rate-fixing/central-bank-exchange-rate-fixing/daily.txt";
