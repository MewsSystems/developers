...
public class CzechNationalBankRestApiExchangeRateProvider : IExchangeRateProvider
{
    ...
    public CzechNationalBankRestApiExchangeRateProvider(ILogger<CzechNationalBankRestApiExchangeRateProvider> logger, AppConfiguration appConfiguration)
    {
        _logger = logger;
    ...
    public async Task<IEnumerable<ExchangeRate>> GetExchangeRatesAsync(IEnumerable<Currency> currencies)
    {
        ...
        var response = await httpClient.GetStringAsync($"{_appConfiguration.DailyRateUrl}/cnbapi/exrates/daily?date={currentDate}&lang=EN");
