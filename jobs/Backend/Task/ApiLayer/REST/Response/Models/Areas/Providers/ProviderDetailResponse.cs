...
/// <summary>
/// API response model for detailed provider information including configurations.
/// </summary>
public class ProviderDetailResponse
{
    ...
    /// <summary>
    /// Reference to API key in Azure Key Vault (if applicable).
    /// </summary>
    ...
    /// </summary>
    public List<ProviderConfigurationResponse> Configurations { get; set; } = new();
