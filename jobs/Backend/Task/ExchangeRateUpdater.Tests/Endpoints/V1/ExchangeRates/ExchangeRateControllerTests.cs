...
namespace ExchangeRateUpdater.Tests.Endpoints.V1.ExchangeRates
{
	public class ExchangeRateControllerTests : IClassFixture<WebApplicationFactoryMock>
	{
		private readonly HttpClient _client;

		private readonly HttpMessageHandlerMock _messageHandlerMock;

		public ExchangeRateControllerTests(WebApplicationFactoryMock application)
		{
			_client = application.CreateClient();
			_messageHandlerMock = application.MessageHandlerMock;
		}

		[Fact]
		public async Task GetExchangesForValidCurrency()
		{
			this._messageHandlerMock.SetMockResponse(HttpStatusCode.OK, "{\r\n\"rates\": [\r\n{\r\n \"currencyCode\": \"EUR\",\r\n\"amount\": 1,\r\n\"validFor\": \"2024-05-02\",\r\n\"rate\": 25.09\r\n}\r\n]\r\n}");
			...
			Assert.NotNull(rate);
			Assert.Equal("CZK", rate.SourceCurrency);
		...
		public async Task GetExchangesForValidCurrencyAndDate()
		{
			...
			DateTime date = DateTime.Parse("2025-03");
		...
		{
			this._messageHandlerMock.SetMockResponse(HttpStatusCode.InternalServerError, string.Empty);
