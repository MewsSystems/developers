...
a) write a program in any language you would like (or even pseudocode) that reads this file and prints out which requests regressed and also the approximate time of it with 5-minute tolerance
b) describe an approach how you would find which requests regressed and also the approximate time of it with 5-minute tolerance
