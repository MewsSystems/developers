...
import {CircularProgress, Grid, Input, Pagination, styled, Typography} from "@mui/material";
...
export const MoviesListView = () => {
    ...
    return <Grid container spacing={2}>
        <Grid item xs={12}>
            <StyledInput onChange={debounce(handleChange, 300)} placeholder={'Search for a movie'} defaultValue={query} />
        ...
        {hasResults &&
            <Grid item xs={12} >
                <StyledPagination count={totalPages} onChange={handleClickPagination} page={currentPage} />
            </Grid>
        }
    </Grid>
}
