...
import MovieGenres from '@/pages/MovieDetail/components/MovieGenres';
import useGetMovieDetail from '@/pages/MovieDetail/hooks/useGetMovieDetail';
import MovieActors from '@/pages/MovieDetail/components/MovieActors';
