...
const SearchBox = ({ placeHolder, searchTerm, onSearchTermChanged = term => {} }) => {
  return (
    <SearchBar>
      <input value={searchTerm} onChange={onSearchTermChanged} type="text" placeholder={placeHolder}></input>
      <SearchIcon />
    </SearchBar>
  );
};
