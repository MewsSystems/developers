module ProviderDateTime
  ...
  def calculate_next_publication(update_frequency, publication_time, current_time = Time.zone.now)
  ...
  def calculate_next_daily_publication(publication_time, current_time, working_days_only)
    ...
    Utils::DateTimeHelper.adjust_for_working_days(next_pub, working_days_only: working_days_only)
  end
  ...
  delegate :adjust_for_working_days, to: :'Utils::DateTimeHelper'
  ...
  delegate :calculate_next_hourly_publication, to: :'Utils::DateTimeHelper'
  ...
  delegate :publication_time_for_date, to: :'Utils::DateTimeHelper'
  ...
  def next_business_day(time, working_days_only: true)
    Utils::DateTimeHelper.next_business_day(time, working_days_only: working_days_only)
  end
end