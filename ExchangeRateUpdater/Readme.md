# Mews Backend developer interview task
...
This is to implement a fully functional provider based on real world public data source. For some of the banks, the fastest applicants managed to implement this in less than an hour.
