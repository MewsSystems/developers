...
- [Backend task](Backend) for candidates for [Backend developer](Backend/Job.md) position.
- [Frontend task](Frontend) for candidates for [Fronted developer](Fronted/Job.md) position.
- [Android Task](Android) for candidates for [Android developer](Android/Job.md) position.
