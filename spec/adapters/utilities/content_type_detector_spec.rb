...
RSpec.describe Adapters::Utilities::ContentTypeDetector do
  describe '.xml_content_type?' do
    it 'returns true for XML content types' do
      ...
      expect(described_class.xml_content_type?('application/xhtml+xml')).to be true
    end
    ...
    it 'returns false for non-XML content types' do
      ...
      expect(described_class.xml_content_type?('text/plain')).to be false
    end
  ...
  describe '.json_content_type?' do
    it 'returns true for JSON content types' do
      expect(described_class.json_content_type?('application/json')).to be true
      expect(described_class.json_content_type?('text/json')).to be true
    end
    ...
    it 'returns false for non-JSON content types' do
      expect(described_class.json_content_type?('application/xml')).to be false
      expect(described_class.json_content_type?('text/plain')).to be false
    end

    it 'returns false for nil' do
      expect(described_class.json_content_type?(nil)).to be false
    end
  end

  describe '.txt_content_type?' do
    it 'returns true for text content types' do
      expect(described_class.txt_content_type?('text/plain')).to be true
      expect(described_class.txt_content_type?('text/txt')).to be true
      expect(described_class.txt_content_type?('application/txt')).to be true
      expect(described_class.txt_content_type?('text/csv')).to be true
    end
    ...
    it 'returns false for non-text content types' do
      expect(described_class.txt_content_type?('application/json')).to be false
      expect(described_class.txt_content_type?('application/xml')).to be false
    end

    it 'returns false for nil' do
      expect(described_class.txt_content_type?(nil)).to be false
    end
  end
