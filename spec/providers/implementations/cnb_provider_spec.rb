...
USA|dollar|1|USD|23.117
  ...
  it "uses JSON adapter when content type is JSON" do
    ...
    usd_rate = ExchangeRate.new(from: Currency.new('CZK'), to: Currency.new('USD'), rate: 21.123,
                                date: Date.parse('2023-10-15'))
    eur_rate = ExchangeRate.new(from: Currency.new('CZK'), to: Currency.new('EUR'), rate: 23.456,
                                date: Date.parse('2023-10-15'))
